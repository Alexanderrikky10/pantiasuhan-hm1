            ...
            <div class="col-lg-4 col-md-6 about-in blog-grid-info text-left mt-5">
              <div class="card img">
                <div class="card-body img">
                  <a href="/detail-berita/{{ $item->id }}" class="d-block">
                    <img src="{{ asset('storage/'. $item->image) }}" alt="{{ $item->title }}" class="img-fluid radius-image">
                  </a>
                  <div class="blog-des mt-4">
                    <h5 class="card-title mb-2"><a href="/detail-berita/{{ $item->id }}"> {{ $item->title }} </a></h5>
